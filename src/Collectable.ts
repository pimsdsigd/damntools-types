...
export interface Collectable<T> {
  ...
  peek(action: (value: T) => void): Collectable<T>

  peek(action: (value: T, index: number) => void): Collectable<T>

  peek(action: (value: T, index: number, array: Collectable<T>) => void): Collectable<T>

  peekPresent(action: (value: T) => void): Collectable<T>

  peekPresent(action: (value: T, index: number) => void): Collectable<T>

  peekPresent(
    action: (value: T, index: number, arr: Collectable<T>) => void
  ): Collectable<T>

  forEach(action: (value: T) => void): Collectable<T>

  forEach(action: (value: T, index: number) => void): Collectable<T>

  forEach(action: (value: T, index: number, arr: Collectable<T>) => void): Collectable<T>

  map<U>(action: (value: T) => U): Collectable<U>

  map<U>(action: (value: T, index: number) => U): Collectable<U>

  map<U>(action: (value: T, index: number, arr: Collectable<T>) => U): Collectable<U>

  mapDefined<U>(action: (value: T) => U | undefined): Collectable<U>

  mapDefined<U>(action: (value: T, index: number) => U | undefined): Collectable<U>

  mapDefined<U>(
    action: (value: T, index: number, arr: Collectable<T>) => U | undefined
  ): Collectable<U>

  mapUndefined<U>(action: (value: T) => U | T): Collectable<U | T>

  mapUndefined<U>(action: (value: T, index: number) => U | T): Collectable<U | T>
  ...
  flatMap<U>(
    action: (value: T) => Collectable<U> | Array<U>,
    depth?: number,
    castType?: ClassType<U>
  ): Collectable<U>

  flatMap<U>(
    action: (value: T, index: number) => Collectable<U> | Array<U>,
    depth?: number,
    castType?: ClassType<U>
  ): Collectable<U>

  flatMap<U>(
    action: (value: T, index: number, arr: Collectable<T>) => Collectable<U> | Array<U>,
    depth?: number,
    castType?: ClassType<U>
  ): Collectable<U>
